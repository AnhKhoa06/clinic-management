...
namespace backend.Migrations
{
    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    Role = table.Column<string>(type: "longtext", nullable: false, defaultValue: "Patient")
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    IsActive = table.Column<bool>(type: "tinyint(1)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AppointmentSlots_WorkingSchedules_WorkingScheduleId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppointmentSlots_DoctorId_SlotDate_SlotTime",
                table: "AppointmentSlots",
                columns: new[] { "DoctorId", "SlotDate", "SlotTime" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_AppointmentSlots_WorkingScheduleId",
                table: "AppointmentSlots",
